        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-20">
          ...
          <div className="lg:col-span-5 space-y-10">
            <div className="space-y-6">
              ...
              <p className="text-slate-400 text-lg leading-relaxed max-w-md">
                Mastering data structures and algorithms through interactive
                real-time visualization.
              </p>
            </div>

            {/* Premium Social Icons - High Visibility */}
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-12 text-sm pt-4">
            ...
            <div className="space-y-6 flex flex-col items-start">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-full text-emerald-500 font-bold text-[10px] tracking-widest">
...
// Custom Social Icon Component for High Visibility
